...
%In the backend, the solving functionality was updated to 
...
This provides two new use cases to add to those identified in \Cref{sec:researchconclusions}, \Cref{tab:requirements}. 
