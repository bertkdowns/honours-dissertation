...
\Cref{tab:gaps_functionality} summarises what additional functionality would be required to communicate with a factory system. These can be viewed as the ``Digital Twin Adapter'' and ``Digital Twin State'' as outlined in \cref{sec:theoretical_framework}.

\begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{research_journal_framework_full.pdf}
    \caption{Theoretical framework for }
\end{figure}
