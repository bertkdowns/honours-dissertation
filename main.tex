...
% talk about how temp sensors are insufficient to define the system

% include screenshots of the platform, a table of the temperature sensors, and maybe (as an appendix) the full thermodynamic properties of the system, calculation modes, etc.

% what we did to overcome it, the limitations, and further improvements
